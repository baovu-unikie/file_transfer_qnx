...
static void usage(void)
{
	...
	printf("\tipc_receivefile --[protocol] --file [destination-file]\n");
	printf("Using the default protocol (message) \n");
	printf("\tipc_receivefile --file [destination-file]\n");
	printf("Make sure you gave the correct path to the destination file\n");
	exit(1);
}
